        ...
        <div className="container mx-auto flex flex-col text-left justify-center pl-16 pr-16">
            ...
            <div className='flex flex-row'>
                ...
                <div className="flex flex-col ml-6 mt-2">
                    <div className="text-2xl font-extrabold inline">Abihnav Gorantla</div>
                    <div className="text-gray-500 text-2xl font-extrabold block">Q Block 9791558808</div>
                </div>
            </div>
            <div className="flex flex-row justify-between mt-4">
                <div className="flex flex-col w-1/4">
                    <div><span className="font-bold">Email </span>abhinav20016@gmail.com</div>
                    <div><span className="font-bold">Alternate Contact </span>1234567890</div>
                    <div><span className="font-bold">Address </span>Room No. 1234, Q Block</div>
                ...
                <div className="flex flex-col w-1/4">
                    ...
                    <div><span className="font-bold">UPI ID </span>test1234@upi</div>
